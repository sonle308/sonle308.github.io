BasicGame.GameSakuya = function (game) {
...
BasicGame.GameSakuya.prototype = {
    create: function () {
        // Boss time
        ...
        // Sound
        this.seTheme = this.game.add.audio('seTheme');
        this.seTheme.volume = 1;
        ...
        this.reimuSBullets.createMultiple(2000, 'sbulletR');
        ...
        this.reimuBullets.createMultiple(200, 'bulletR');
        ...
        this.waveFairy1.createMultiple(10, 'fairysprite1');
        ...
        this.waveFairy2.createMultiple(10, 'fairysprite1');
        ...
        this.fairy3Bullets.createMultiple(300, 'bullet1');
        ...
        this.waveFairy5.createMultiple(10, 'fairysprite3');
        ...
        this.luna.createMultiple(10, 'eLuna');
        ...
        this.lunaBullets.createMultiple(300, 'bullet1');
        ...
        this.sunny.createMultiple(20, 'eSunny');
        ...
        this.sunnyBullets.createMultiple(300, 'bullet1');
        ...
        this.star.createMultiple(30, 'eStar');
        ...
        this.starBullets.createMultiple(300, 'bullet1');
        ...
        this.game.time.events.add(10000, this.launchLunaEnemy, this);
        this.game.time.events.add(20000, this.launchSunnyEnemy, this);
        this.game.time.events.add(10000, this.launchStarEnemy, this);
        this.game.time.events.add(10000, this.lauchWaveFairy1, this);
        this.game.time.events.add(5000, this.lauchWaveFairy2, this);
        this.game.time.events.add(10000, this.lauchWaveFairy3, this);
        this.game.time.events.add(5000, this.lauchWaveFairy4, this);
        this.game.time.events.add(1000, this.lauchWaveFairy5, this);
        ...
        this.explosions.createMultiple(3000, 'explosion');
        ...
        this.bulletExplosions.createMultiple(3000, 'explosion-bullet');
    ...
    update: function () {
        ...
        //  Weapon upgrade
        if (this.score > 20000 && this.reimu.weaponLevel < 2) {
            this.reimu.weaponLevel = 2;
            this.orb0.alpha = 0;
            this.orb1.alpha = 1;
            this.orb2.alpha = 1;
        }
        else if (this.score > 50000 && this.reimu.weaponLevel < 3) {
        ...
        else if (this.score > 200000 && this.reimu.weaponLevel < 4) {
            this.reimu.weaponLevel = 4;
        }
        else if (this.score > 500000 && this.reimu.weaponLevel < 5) {
                ...
                if (this.checkMode === false) {
                    for(var i = 0; i < 4; i++){
                        ...
                        var spreadAngle;
                            ...
                            this.reimuBullet.damageAmount = 30;
                            this.seShot.play();
                ...
                if (this.checkMode === false) {
                    for(var i = 0; i < 4; i++){
                        ...
                        var spreadAngle;
                            ...
                            if (i === 2){ spreadAngle = -3; this.reimuBullet.reset(this.orb3.x, this.orb3.y);} 
                            if (i === 3){ spreadAngle = 3; this.reimuBullet.reset(this.orb4.x, this.orb4.y);}
                            this.reimuBullet.damageAmount = 25;
                            this.seShot.play();
                            this.reimuBullet.alpha = 0.5;
                            this.reimuBullet.angle = spreadAngle;
                            this.game.physics.arcade.velocityFromAngle(spreadAngle - 90, this.BULLET_SPEED, this.reimuBullet.body.velocity);
                            var state = this;
                            this.reimuBullet.update = function() {
                                if (this.x > (state.game.width-320)) {
                                    this.kill();
                                }
                            }
                        }
            ...
            if (this.game.time.now > this.sBulletTimer) {
                if (this.checkMode === false) {
                    ...
                    if (this.reimuSBullet) {
                        ...
                        this.reimuSBullet.damageAmount = 100;
                    ...
                    this.sBulletTimer = this.game.time.now + 200;
                }
                else {
                    this.reimuSBullet = this.reimuSBullets.getFirstExists(false);
                    var spreadAngle;
    ...
    launchLunaEnemy: function() {
        ...
        if(this.game.time.now < this.bossTimeAppear) {
            this.game.time.events.add(this.game.rnd.integerInRange(1500, 3000), this.launchLunaEnemy, this);
        }
    },
    ...
    launchSunnyEnemy: function() {
        ...
        if(this.game.time.now < this.bossTimeAppear) {
            this.game.time.events.add(5000, this.launchSunnyEnemy, this);
        }
    },
    ...
    launchStarEnemy: function() {
        ...
        if(this.game.time.now < this.bossTimeAppear) { 
            this.game.time.events.add(timeBetweenWaves, this.launchStarEnemy, this);
        }
    },
    ...
    lauchWaveFairy1: function() {
        ...
        if(this.game.time.now < this.bossTimeAppear) { 
            this.game.time.events.add(timeBetweenWaves, this.lauchWaveFairy1, this);
        }
    },
    ...
    lauchWaveFairy2: function() {
        ...
        if(this.game.time.now < this.bossTimeAppear) { 
            this.game.time.events.add(timeBetweenWaves, this.lauchWaveFairy2, this);
        }
    },
    ...
    lauchWaveFairy4: function() {
        ...
        if(this.game.time.now < this.bossTimeAppear) {
            this.game.time.events.add(1000, this.lauchWaveFairy4, this);
        }
    },
    ...
    lauchWaveFairy5: function() {
        ...
        if(this.game.time.now < this.bossTimeAppear) { 
            this.game.time.events.add(timeBetweenWaves, this.lauchWaveFairy5, this);
        }
    },
    ...
    reimuCollide: function(reimu, enemy) {
        ...
        this.aura.damage(enemy.damageAmount);
    },
    ...
    hitEnemy: function(enemy, bullet) {
        ...
        if (enemy.health <= 0) {
            ...
            // Increase score
            this.score += Math.floor(enemy.score+enemy.score*(this.score/1000000)*(this.reimu.health/100));
    ...
    enemyHitsPlayer: function(reimu, bullet) {
        ...
        this.aura.damage(bullet.damageAmount);
    },
