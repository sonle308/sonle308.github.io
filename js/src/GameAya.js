BasicGame.GameAya = function (game) {
...
BasicGame.GameAya.prototype = {
    create: function () {
        ...
        this.marisaSBullets.createMultiple(80, 'sbulletM');
        ...
        this.game.time.events.add(7000, this.lauchWaveFairy1, this);
        this.game.time.events.add(10000, this.lauchWaveFairy2, this);
        this.game.time.events.add(15000, this.lauchWaveFairy3, this);
        this.game.time.events.add(12000, this.lauchWaveFairy4, this);
        this.game.time.events.add(4000, this.lauchWaveFairy5, this);
    ...
    update: function () {
        console.log(this.marisa.weaponLevel);
        ...
        else if (this.score > 300000 && this.marisa.weaponLevel < 3) {
            this.marisa.weaponLevel = 3;
        }
        else if (this.score > 1000000 && this.marisa.weaponLevel < 4) {
            this.marisa.weaponLevel = 4;
        }
        else if (this.score > 3000000 && this.marisa.weaponLevel < 5) {
                    ...
                    for(var i = 0; i < 2; i++){
                        ...
                        if (this.marisaSBullet) {
                            ...
                            if(this.line1check===true) {
                                ...
                                this.marisaSBullet.damageAmount = 25;
                                this.seShot.play();
                                this.marisaSBullet.alpha = 1;
                ...
                if (this.checkMode === false) {
                    for(var i = 0; i < 2; i++){
                        ...
                        var spreadAngle;
                            if (i === 0){ spreadAngle = -1.5; this.marisaBullet.reset(this.miniHakkero1.x, this.miniHakkero1.y);} 
                            if (i === 1){ spreadAngle = 1.5; this.marisaBullet.reset(this.miniHakkero2.x, this.miniHakkero2.y);}
                            if (i === 2){ spreadAngle = -3; this.marisaBullet.reset(this.miniHakkero3.x, this.miniHakkero3.y);} 
                            if (i === 3){ spreadAngle = 3; this.marisaBullet.reset(this.miniHakkero4.x, this.miniHakkero4.y);}
                            this.marisaBullet.damageAmount = 50;
                            this.seShot.play();
                            this.marisaBullet.angle = spreadAngle;
                            this.game.physics.arcade.velocityFromAngle(spreadAngle - 90, this.BULLET_SPEED, this.marisaBullet.body.velocity);
            ...
            if (this.game.time.now > this.sBulletTimer) {
                if (this.checkMode === false) {
                    for(var i = 0; i < 4; i++){
                        ...
                        if (this.marisaSBullet) {
                            var spreadAngle;
                            if (i === 0){ spreadAngle = this.game.rnd.integerInRange(-60, 60); this.marisaSBullet.reset(this.miniHakkero1.x, this.miniHakkero1.y);} 
                            if (i === 1){ spreadAngle = this.game.rnd.integerInRange(-60, 60); this.marisaSBullet.reset(this.miniHakkero2.x, this.miniHakkero2.y);}
                            if (i === 2){ spreadAngle = this.game.rnd.integerInRange(-60, 60); this.marisaSBullet.reset(this.miniHakkero3.x, this.miniHakkero3.y);} 
                            if (i === 3){ spreadAngle = this.game.rnd.integerInRange(-60, 60); this.marisaSBullet.reset(this.miniHakkero4.x, this.miniHakkero4.y);}
                            this.marisaSBullet.damageAmount = 50;
                            this.seShot.play();
                            this.marisaSBullet.alpha = 1;
                            this.marisaSBullet.angle = spreadAngle;
                            this.game.physics.arcade.velocityFromAngle(spreadAngle - 90, 800, this.marisaSBullet.body.velocity);
                        }
                        this.sBulletTimer = this.game.time.now + 100;
                    }
                }
                else {
                    for(var i = 0; i < 4; i++){
                        ...
                        if (this.marisaSBullet) {
                            var spreadAngle;
                            if (i === 0){ spreadAngle = 1; this.marisaSBullet.reset(this.miniHakkero1.x, this.miniHakkero1.y);} 
                            if (i === 1){ spreadAngle = -1; this.marisaSBullet.reset(this.miniHakkero2.x, this.miniHakkero2.y);}
                            if (i === 2){ spreadAngle = 2; this.marisaSBullet.reset(this.miniHakkero3.x, this.miniHakkero3.y);} 
                            if (i === 3){ spreadAngle = -2; this.marisaSBullet.reset(this.miniHakkero4.x, this.miniHakkero4.y);}
                            this.marisaSBullet.damageAmount = 50;
                            this.seShot.play();
                            this.marisaSBullet.alpha = 1;
                            this.marisaSBullet.angle = spreadAngle;
    ...
    launchLunaEnemy: function() {
        ...
        if(this.game.time.now < this.bossTimeAppear) {
            this.game.time.events.add(22000 - this.marisa.weaponLevel*2000, this.launchLunaEnemy, this);
        }
    },
    ...
    launchSunnyEnemy: function() {
        ...
        if(this.game.time.now < this.bossTimeAppear) {
            this.game.time.events.add(22000 - this.marisa.weaponLevel*2000, this.launchSunnyEnemy, this);
        }
    },
    ...
    launchStarEnemy: function() {
        ...
        if(this.game.time.now < this.bossTimeAppear) { 
            this.game.time.events.add(22000 - this.marisa.weaponLevel*2000, this.launchStarEnemy, this);
        }
    },
    ...
    lauchWaveFairy1: function() {
        ...
        if(this.game.time.now < this.bossTimeAppear) { 
            this.game.time.events.add(8000 - this.marisa.weaponLevel*500, this.lauchWaveFairy1, this);
        }
    },
    ...
    lauchWaveFairy2: function() {
        ...
        if(this.game.time.now < this.bossTimeAppear) { 
            this.game.time.events.add(8000 - this.marisa.weaponLevel*500, this.lauchWaveFairy2, this);
        }
    },
    ...
    lauchWaveFairy3: function() {
        ...
        if(this.game.time.now < this.bossTimeAppear) { 
            this.game.time.events.add(22000 - this.marisa.weaponLevel*2000, this.lauchWaveFairy3, this);
        }
    },
    ...
    lauchWaveFairy4: function() {
        ...
        if(this.game.time.now < this.bossTimeAppear) {
            this.game.time.events.add(2200 - this.marisa.weaponLevel*200, this.lauchWaveFairy4, this);
        }
    },
    ...
    lauchWaveFairy5: function() {
        ...
        if(this.game.time.now < this.bossTimeAppear) { 
            this.game.time.events.add(6500- this.marisa.weaponLevel*500, this.lauchWaveFairy5, this);
        }
    },
    ...
    hitEnemy: function(enemy, bullet) {
        ...
        if (enemy.health <= 0) {
            ...
            // Increase score
            this.score += Math.floor(enemy.score+enemy.score*(this.score/1000000)*(this.marisa.health/100));
